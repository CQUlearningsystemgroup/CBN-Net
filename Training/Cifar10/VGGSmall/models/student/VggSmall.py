...
class Bypass2_VggSmall_fp(nn.Module):

    def __init__(self, num_classes=10):
        super(Bypass2_VggSmall_fp, self).__init__()
        self.conv0 = nn.Conv2d(3, 128, kernel_size=3, padding=1,bias=False)
        self.bn0 = nn.BatchNorm2d(128)

        self.conv1_1 = nn.Conv2d(128, 128, kernel_size=3, padding=1,bias=False)
        ...
        self.conv3_1 = nn.Conv2d(256, 256, kernel_size=3, padding=1,bias=False)
    ...
    def forward(self, x):
        ...
        # x1 = self.binary(x1+resx2_1)
        # x2 = self.binary(x2+resx1_1)
...
class Bypass2_VggSmall_1w1a(nn.Module):

    def __init__(self, num_classes=10):
        super(Bypass2_VggSmall_1w1a, self).__init__()
        self.conv0 = nn.Conv2d(3, 128, kernel_size=3, padding=1,bias=False)
        self.bn0 = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        ...
        out = self.fc(out)
        return out
class En2_VggSmall_1w1a(nn.Module):

    def __init__(self, num_classes=10):
        super(En2_VggSmall_1w1a, self).__init__()
        self.conv0 = nn.Conv2d(3, 128, kernel_size=3, padding=1,bias=False)
        self.bn0 = nn.BatchNorm2d(128)
    ...
    def forward(self, x):
        ...
        x1 = self.nonlinear(self.bn2_1(self.conv2_1(x1)))
        x2 = self.nonlinear(self.bn2_2(self.conv2_2(x2)))

        x1 = self.nonlinear(self.bn3_1(self.pooling(self.conv3_1(x1))))
        x2 = self.nonlinear(self.bn3_2(self.pooling(self.conv3_2(x2))))


        x1 = self.nonlinear(self.bn4_1(self.conv4_1(x1)))
        x2 = self.nonlinear(self.bn4_2(self.conv4_2(x2)))

        x1 = self.nonlinear(self.bn5_1(self.pooling(self.conv5_1(x1))))
        x2 = self.nonlinear(self.bn5_2(self.pooling(self.conv5_2(x2))))
...
def Bypass2_vgg_small(**kwargs):
    model = Bypass2_VggSmall_fp(**kwargs)
    return model

def En2_vgg_small_1w1a(**kwargs):
    model = En2_VggSmall_1w1a(**kwargs)
    return model

def Bypass2_vgg_small_1w1a(**kwargs):
    model = Bypass2_VggSmall_1w1a(**kwargs)
    return model